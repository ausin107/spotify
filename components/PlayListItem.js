    ...
    <div
      ...
      <div className='flex w-2/5'>
        ...
        <div className=''>
          ...
          <div className='text-iconColor text-sm font-semibold group-hover:text-white'>{channelName}</div>
        </div>
      </div>
      <div className='w-1/4 text-iconColor font-semibold text-sm group-hover:text-white'>{musicName}</div>
      ...
      <div className='flex justify-end items-center w-[12%]'>
        <LoveButton musicId={data.id} musicData={data} />
