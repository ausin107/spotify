...
export default function ExtPLaylist() {
  ...
  return (
    <>
      {!!plInfo && !!plItems ? (
        <>
          <div className='lg:pt-20 pt-16 lg:pb-48 pb-40 px-9 flex lg:flex-row flex-col bg-greyBg lg:items-center'>
            ...
            <div className='lg:px-6 mb-4 lg:mb-0 lg:w-3/4 lg:h-60'>
              ...
              <div className='text-white font-bold lg:text-7xl lg:h-[65%] text-2xl lg:mb-12 mb-2 normal-case overflow-hidden'>
